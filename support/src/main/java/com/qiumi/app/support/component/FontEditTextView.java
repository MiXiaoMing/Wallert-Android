...
public class FontEditTextView extends EditText {
    ...
    public FontEditTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public FontEditTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
