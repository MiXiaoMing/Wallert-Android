 ...
 * 快速提现
 */
public class TransferOutActivity extends AutoBaseActivity {

    private String id, name;

    private EditText etTelephone, etNumber, etPwd, etPhoneConfirm;
    private TextView tvNumberName, tvFeeName, tvFee, tvPhoneConfirm;
    ...
    private View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (viewId == R.id.rlyBack) {
                ...
                Intent intent = new Intent(TransferOutActivity.this, AssetRecordActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (result != null) {
            if (result.getContents() == null) {
                ...
                // TODO: 2019/8/26 需要转换为手机号
                etTelephone.setText(result.getContents());
                etTelephone.setSelection(result.getContents().length());
            }
        } else {
        ...
        new WalletDataManager()
                ...
                .subscribe(new CustomResult<AmountEntity>() {
                    ...
                    public void onSuccess(AmountEntity result) {
                        if (ActivityUtil.isAvailable(TransferOutActivity.this) && result.getData().fee != null) {
        ...
        new WalletDataManager()
                ...
                .subscribe(new CustomResult<EmptyHttpResult>() {
                    ...
                    public void onSuccess(EmptyHttpResult result) {
                        if (ActivityUtil.isAvailable(TransferOutActivity.this)) {
                            AFToast.showShort(TransferOutActivity.this, R.string.send_smscode_success);
    ...
    // TODO: 2020/3/12 需要判断是否为新用户， 如果是，则不进行下一步，直接弹框提示

    private void submit() {
        String phone = etTelephone.getText().toString().trim();
        if (TextUtils.isEmpty(phone)) {
            if (ActivityUtil.isAvailable(TransferOutActivity.this)) {
                AFToast.showShort(TransferOutActivity.this, "手机号不能为空");
            }
            return;
        }
        ...
        if (TextUtils.isEmpty(amount)) {
            if (ActivityUtil.isAvailable(TransferOutActivity.this)) {
                AFToast.showShort(TransferOutActivity.this, "转账金额不能未空");
            }
            return;
        }
        ...
        if (TextUtils.isEmpty(payPass)) {
            if (ActivityUtil.isAvailable(TransferOutActivity.this)) {
                AFToast.showShort(TransferOutActivity.this, "请输入支付密码");
            }
            return;
        }
        ...
        if (TextUtils.isEmpty(smsCode)) {
            if (ActivityUtil.isAvailable(TransferOutActivity.this)) {
                AFToast.showShort(TransferOutActivity.this, "请输入验证码");
            }
            return;
        }

        TransferOutBody body = new TransferOutBody();
        // TODO: 2020/3/12 这里需要优化
        body.toCountryCode = "+86";
        body.toMobile = phone;
        ...
        Map<String, String> signParams = new HashMap<>();
        signParams.put("toMobile", body.toMobile);
        ...
        new WalletDataManager()
                ...
                .subscribe(new CustomResult<TransferSubmitEntity>() {
                    ...
                    public void onSuccess(TransferSubmitEntity result) {
                        if (ActivityUtil.isAvailable(TransferOutActivity.this)) {
                            AFToast.showShort(TransferOutActivity.this, result.getMessage());
